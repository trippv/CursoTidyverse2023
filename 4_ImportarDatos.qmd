...
Otra herramienta un poco mas sofisticada pero bastante útil es la función `gt_plt_summary()` del paquete **gtExtras**, la cual nos permite graficar cada una de las variables, nos muestra los valores promedio, mediana y desviación, y además nos muestra el % de valores faltantes (missing).
