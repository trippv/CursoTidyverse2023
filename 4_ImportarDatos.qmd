...
4.  Visualiza con `summary` o con `glimpse()` las variables de la tabla. ¿Cuales de ellas son categóricas?
...
# importar datos. inicia con la tercera linea
e1 <- read_xlsx("data/ejercicio_readxls.xlsx", skip = 3)

# limpiar los nombres con janitor
e1_clean <- clean_names(e1)

# ver un summary de los datos
summary(e1_clean)

# guardar los datos en el directorio resultados/tablas
