...
Existen dos métodos para salvar un objetvo ggplot2. Puedes utilizar la aproximación estandar de R, donde se abre un dispositivo gráfico (_graphic device_), generar el gráfico y posteriormente cerrar el dispositivo:
