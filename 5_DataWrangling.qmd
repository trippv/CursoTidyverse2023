...
Este es un bloque personalizado con un gorro de graduación como ícono.
:::
...
Cuando generas una nueva conlumna con mutate, puedes ajustar la posición de la columna incluyendo el parámetro `.before =` o `.after =` indicando la posición de la columna deseada
