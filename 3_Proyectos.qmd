...
![\@allison_horst](img/Horst_functions/rProj.png){fig-align="center" width="613"}
...
El paquete [**`here()`**](https://here.r-lib.org/) se utiliza para construir rutas de archivos y directorios de manera relativa al directorio del proyecto actual. En lugar de utilizar rutas absolutas (que especifican la ruta completa desde la raíz del sistema de archivos) o rutas relativas estándar (que se basan en la ubicación del script en ejecución), **`here()`** crea rutas relativas desde el directorio del proyecto.
:::

![](img/Horst_functions/here.png){fig-align="center" width="560"}
