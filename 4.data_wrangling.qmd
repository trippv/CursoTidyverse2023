...
Si buscamos multiples patrones dentro de nuestra variable con caracteres, podemos separarlas dentro de las comillas usando el símbolo "|". Por ejemplo, si queremos buscar los Pokemon cuyo nombre termine con "_saur_" o que empieza con "_Char_":
...
Usando las herramientas vistas en el curso contesta lo siguiente:
